...
const juaMtotoWakodefs = require('../../app/reporting-framework/hiv/jua-mtoto-wako.json');
const moh412Indicators = require('../../app/reporting-framework/json-reports/moh-412/moh-412-indicators.json');

export class JuaMtotoWakoService extends MultiDatasetPatientlistReport {
        ...
        .then((results) => {
          if (additionalParams && additionalParams.type === 'patient-list') {
            ...
            resolve({
              ...
              sectionDefinitions: juaMtotoWakodefs,
